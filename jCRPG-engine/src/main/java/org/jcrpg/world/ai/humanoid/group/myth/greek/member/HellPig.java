...
public class HellPig extends MythicBaseMember {
	...
	static
	{
		...
		desc.IDLE = "../media/models/monster/hellpig/idle.md5anim";		
		desc.IDLE_COMBAT = "../media/models/monster/hellpig/idle.md5anim";
		desc.WALK = "../media/models/monster/hellpig/forward.md5anim";
		desc.ATTACK_LOWER = "../media/models/monster/hellpig/attack.md5anim";
		desc.ATTACK_UPPER = "../media/models/monster/hellpig/attack.md5anim";
		desc.DEFEND_LOWER = "../media/models/monster/hellpig/jump.md5anim";
		desc.DEFEND_UPPER = "../media/models/monster/hellpig/jump.md5anim";
		desc.PAIN = "../media/models/monster/hellpig/hit.md5anim";
		desc.DEATH_NORMAL = "../media/models/monster/hellpig/die.md5anim";
		desc.DEAD = "../media/models/monster/hellpig/die.md5anim";
		hellPig = new MovingModel("../media/models/monster/hellpig/hellpig2.md5mesh",desc,null,null,false);
