...
*/
	...
	static {
		...
		desc.IDLE = "../media/models/humanoid/anatipion/anat1_idle.md5anim";		
		desc.IDLE_COMBAT = "../media/models/humanoid/anatipion/anat1_idle.md5anim";
		desc.WALK = "../media/models/humanoid/anatipion/anat1_idle.md5anim";
		desc.ATTACK_LOWER = "../media/models/humanoid/anatipion/anat1_attack.md5anim";
		desc.ATTACK_UPPER = "../media/models/humanoid/anatipion/anat1_attack.md5anim";
		desc.DEFEND_LOWER = "../media/models/humanoid/anatipion/anat1_hit.md5anim";
		desc.DEFEND_UPPER = "../media/models/humanoid/anatipion/anat1_hit.md5anim";
		desc.PAIN = "../media/models/humanoid/anatipion/anat1_hit.md5anim";
		desc.DEATH_NORMAL = "../media/models/humanoid/anatipion/anat1_hit.md5anim";
		desc.DEAD = "../media/models/humanoid/anatipion/anat1_hit.md5anim";
		anatipionMale = new MovingModel("../media/models/humanoid/anatipion/anat1.md5mesh",desc,null,null,false);
...
*/
	...
	public static ColorRGBA[][] CITY_COLORED = IconReader.readMapIconFile(MAPICONS_BASEDIR+"sandigloo.ico");
