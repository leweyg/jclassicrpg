...
public class GorillaHorde extends AnimalEntityDescription {
	...
	static 
	{
		MovingModelAnimDescription desc = new MovingModelAnimDescription(new String[]{"../media/models/fauna/gorilla/gorilla_steady.md5anim","../media/models/fauna/gorilla/gorilla.md5anim"});
		desc.WALK = "../media/models/fauna/gorilla/gorilla_steady.md5anim";
		desc.ATTACK_UPPER = "../media/models/fauna/gorilla/gorilla.md5anim";
		desc.ATTACK_LOWER = "../media/models/fauna/gorilla/gorilla.md5anim";
		desc.PAIN = "../media/models/fauna/gorilla/gorilla.md5anim";
		desc.DEFEND_UPPER = "../media/models/fauna/gorilla/gorilla.md5anim";
		desc.DEFEND_LOWER = "../media/models/fauna/gorilla/gorilla.md5anim";
		desc.DEATH_NORMAL = "../media/models/fauna/gorilla/gorilla.md5anim";
		gorilla = new MovingModel("../media/models/fauna/gorilla/gorilla.md5mesh",desc,null,null,false);
