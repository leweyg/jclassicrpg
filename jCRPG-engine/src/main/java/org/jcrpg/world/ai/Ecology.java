...
public class Ecology {
	...
	public Collection<EncounterInfo> getNearbyEncounters(int seed, EntityInstance entityInstance)
	{
		...
		for (EntityFragment fragment:entityInstance.fragments.fragments) 
		{
			...
			for (EncounterUnit f:listOfCommonRadiusFragments.keySet())
			{
				...
				Vector3 v1 = new Vector3(r[1][0],r[1][1],r[1][2]); // this is the vector of intersection point to measure to the others distance.
				...
				for (Object o:elements)
				{
					...
					Vector3 v2 = new Vector3(r2[1][0],r2[1][1],r2[1][2]); // the comparator vector for the intersection point
	...
	public void doTurn()
	{
		...
		if (!interrupted)
		{
			...
			J3DCore.getInstance().getCanvas().getCanvasRenderer().draw();
