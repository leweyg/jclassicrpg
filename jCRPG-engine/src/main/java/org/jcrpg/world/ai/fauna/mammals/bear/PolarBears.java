...
public class PolarBears extends AnimalEntityDescription {
	...
	public static MovingModel polarbear = new MovingModel("models/fauna/polarbear_tex.obj",null,null,null,false);;//new MovingModel("../media/models/fauna/gorilla/gorilla.md5mesh","../media/models/fauna/gorilla/gorilla_steady.md5anim",null,null,false);
