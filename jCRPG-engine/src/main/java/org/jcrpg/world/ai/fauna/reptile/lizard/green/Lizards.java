...
public class Lizards extends AnimalEntityDescription {
	...
	static {
		...
		desc.IDLE = "../media/models/fauna/lizard/lizard1_idle.md5anim";		
		desc.IDLE_COMBAT = "../media/models/fauna/lizard/lizard1_idle.md5anim";
		desc.WALK = "../media/models/fauna/lizard/lizard1_idle.md5anim";
		desc.ATTACK_LOWER = "../media/models/fauna/lizard/lizard1_attack.md5anim";
		desc.ATTACK_UPPER = "../media/models/fauna/lizard/lizard1_attack.md5anim";
		desc.DEFEND_LOWER = "../media/models/fauna/lizard/lizard1_hit.md5anim";
		desc.DEFEND_UPPER = "../media/models/fauna/lizard/lizard1_hit.md5anim";
		desc.PAIN = "../media/models/fauna/lizard/lizard1_hit.md5anim";
		desc.DEATH_NORMAL = "../media/models/fauna/lizard/lizard1_hit.md5anim";
		desc.DEAD = "../media/models/fauna/lizard/lizard1_hit.md5anim";
		greenLizard = new MovingModel("../media/models/fauna/lizard/lizard1.md5mesh",desc,null,null,false);
