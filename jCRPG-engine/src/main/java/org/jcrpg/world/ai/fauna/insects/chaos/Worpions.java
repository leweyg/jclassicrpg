...
public class Worpions  extends AnimalEntityDescription {
	...
	public static MovingModel worpion = new MovingModel("models/monster/worpion/worpion.obj",null,null,null,false);;//new MovingModel("../media/models/fauna/gorilla/gorilla.md5mesh","../media/models/fauna/gorilla/gorilla_steady.md5anim",null,null,false);
