...
*/
	...
	static {
		...
		desc.IDLE = "../media/models/humanoid/yeti/yeti1_idle.md5anim";		
		desc.IDLE_COMBAT = "../media/models/humanoid/yeti/yeti1_idle.md5anim";
		desc.WALK = "../media/models/humanoid/yeti/yeti1_idle.md5anim";
		desc.ATTACK_LOWER = "../media/models/humanoid/yeti/yeti1_attack.md5anim";
		desc.ATTACK_UPPER = "../media/models/humanoid/yeti/yeti1_attack.md5anim";
		desc.DEFEND_LOWER = "../media/models/humanoid/yeti/yeti1_hit.md5anim";
		desc.DEFEND_UPPER = "../media/models/humanoid/yeti/yeti1_hit.md5anim";
		desc.PAIN = "../media/models/humanoid/yeti/yeti1_hit.md5anim";
		desc.DEATH_NORMAL = "../media/models/humanoid/yeti/yeti1_hit.md5anim";
		desc.DEAD = "../media/models/humanoid/yeti/yeti1_hit.md5anim";
		yetiMale = new MovingModel("../media/models/humanoid/yeti/yeti1.md5mesh",desc,null,null,false);
...
*/
	...
	public static ColorRGBA[][] CITY_COLORED = IconReader.readMapIconFile(MAPICONS_BASEDIR+"igloo.ico");
