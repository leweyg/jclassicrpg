...
public class GiantCaveSpiders extends AnimalEntityDescription {
	...
	public static MovingModel giantcavespider = new MovingModel("models/fauna/spider.obj",null,null,null,false);;//new MovingModel("../media/models/fauna/gorilla/gorilla.md5mesh","../media/models/fauna/gorilla/gorilla_steady.md5anim",null,null,false);
