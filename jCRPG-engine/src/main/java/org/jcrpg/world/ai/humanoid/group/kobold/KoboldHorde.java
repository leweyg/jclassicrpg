...
public class KoboldHorde extends HumanoidEntityDescription {
	...
	static {
		MovingModelAnimDescription desc = new MovingModelAnimDescription("../media/models/humanoid/kobold/kobold_pose.md5anim");
		koboldMaleMiner = new MovingModel("../media/models/humanoid/kobold/kobold.md5mesh",desc,null,null,false);
