...
public class BrownBearFamily extends AnimalEntityDescription {
	...
	public static MovingModel brownbear = new MovingModel("models/fauna/warbear_tex.obj",null,null,null,false);;//new MovingModel("../media/models/fauna/gorilla/gorilla.md5mesh","../media/models/fauna/gorilla/gorilla_steady.md5anim",null,null,false);
