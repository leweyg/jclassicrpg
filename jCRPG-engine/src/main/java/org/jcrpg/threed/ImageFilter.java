...
public abstract class ImageFilter {
         ...
         */
        public com.ardor3d.image.Image apply(com.ardor3d.image.Image sourceImage) {
                width = sourceImage.getWidth();
                height = sourceImage.getHeight();
                componentCount = 3;
                if (sourceImage.getDataFormat() == ImageDataFormat.RGBA) {
                        componentCount = 4;
                }
                
                source = sourceImage.getData(0);
                dest = BufferUtils.createByteBuffer(sourceImage.getData(0).limit());
                Image destImage = new Image(sourceImage.getDataFormat(),sourceImage.getDataType(), width, height, dest,null);
