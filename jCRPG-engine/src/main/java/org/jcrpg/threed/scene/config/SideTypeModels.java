...
public class SideTypeModels {
	...
	public static double CUBE_EDGE_SIZE = J3DCore.CUBE_EDGE_SIZE;
...
*/
		...
		coconut_simple.transparencyBlendNeeded = true;
		...
		jungle_bush_simple.transparencyBlendNeeded = true;
...
//		sm_jungle.atlasTextureNameNormal = "jungle_atlas_nmap.png";
		...
		SimpleModel sm_bookcase = new SimpleModel("models/inside/furniture/bookcase.obj",null);
...
//		hm3dTypeRenderedSide.put(new Integer(33), new RenderedSide(new Model[]{entrance_cave}));
		...
		sm_maze_wall_1.heightMapTexture = "maze_stone_1_h.dds"; 
...
/*		SimpleModel sm_maze_wall_1 = new SimpleModel("sides/maze_wall_thick.obj", "brick_texture.dds");
		...
		TriggeredAnimDescription desc = new TriggeredAnimDescription("../media/models/item/storage/chest_closed.md5anim");
		desc.OPENING = "../media/models/item/storage/chest_opening.md5anim"; 
		desc.OPEN = "../media/models/item/storage/chest_open.md5anim";
		desc.CLOSED= "../media/models/item/storage/chest_closed.md5anim";
		...
		StaticTriggeredModel st_chest = new StaticTriggeredModel("../media/models/item/storage/chest.md5mesh",desc,null,null,true);
		...
		// sm_hut_model = new SimpleModel("models/external/guardtower/guard_tower_pos.obj", null);
		// sm_hut_model = new SimpleModel("models/external/shop/shop_pos.obj", null);
		sm_hut_model.batchEnabled = false; // Model is loaded as Node, error. Fix later TODO
		sm_hut_model.shadowCaster = true;
