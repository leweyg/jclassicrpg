...
public class RenderedMovingUnit {
	...
	public double c3dX, c3dY, c3dZ;
	public double walkHeight = 0f;
	...
	public RenderedMovingUnit(Model[] models) {
		super();
		if (!Jcrpg.TOOL_SESSION && J3DCore.getInstance().mEngine!=null)
		{
	...
	public double startPositionX, startPositionY, startPositionZ;
	public double endPositionX, endPositionY, endPositionZ;
