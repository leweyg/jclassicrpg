...
public class QuadModel extends Model {
	...
	public QuadModel(String textureName,double sizeX, double sizeY) {
		super();
		type = QUADMODEL;
		this.sizeX = sizeX;
		this.sizeY = sizeY;
	...
	public QuadModel(String textureName,String dot3TextureName, double sizeX, double sizeY, boolean normalMap) {
		super();
		type = QUADMODEL;
		this.sizeX = sizeX;
		this.sizeY = sizeY;
