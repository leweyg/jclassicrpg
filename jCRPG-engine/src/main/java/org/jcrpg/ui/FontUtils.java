...
public class FontUtils {
	...
	public static final String GEN_FONT_PATH = "../media/font/free/vinque.ttf"; //"../media/font/free/Sebaldus-Gotisch.ttf"
	...
	static {
		try
		{
			//fontVerdana = Font.createFont(Font.TRUETYPE_FONT, new FileInputStream(new File("../media/font/free/FetteTrumpDeutsch.ttf")));
	...
	static {
		try
		{
			//fontNonBoldVerdana = Font.createFont(Font.TRUETYPE_FONT, new FileInputStream(new File("../media/font/free/FetteTrumpDeutsch.ttf")));
