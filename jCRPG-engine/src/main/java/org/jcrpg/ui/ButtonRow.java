...
public class ButtonRow extends InputWindow {
	...
	public ButtonRow(UIBase base) {
		super(base);
		try {
			Quad hudQuad = loadImageToQuad("nonPatternFrame1.png", 1f*core.getDisplay().getWidth(), rowHeightRatio*(core.getDisplay().getHeight() / 2), 
	    	...
	    	windowNode.attachChildAt(sQuad,0);
	    	
	    	float buttonWidth = 0.077f;
	    	float xOffset = 0.26f;
	    	float rowHeightDiv = 2.25f;
	    	int counter = 0;
	    	menuButton = new ImageButton("1",this,windowNode,xOffset+buttonWidth*counter++, rowHeightRatio/4.2f, buttonWidth, rowHeightRatio/rowHeightDiv, 800f, "  Menu", "topbuttons/mainmenu.png");
	    	mapButton = new ImageButton("2",this,windowNode,xOffset+buttonWidth*counter++, rowHeightRatio/4.2f, buttonWidth, rowHeightRatio/rowHeightDiv, 800f, "  Map", "topbuttons/map.png" );
	    	campButton = new ImageButton("3",this,windowNode,xOffset+buttonWidth*counter++, rowHeightRatio/4.2f, buttonWidth, rowHeightRatio/rowHeightDiv, 800f, "   Camp", "topbuttons/camp.png" );
	    	orderButton = new ImageButton("4",this,windowNode,xOffset+buttonWidth*counter++, rowHeightRatio/4.2f, buttonWidth, rowHeightRatio/rowHeightDiv, 800f, "  Order", "topbuttons/order.png" );
	    	behaviorButton = new ImageButton("5",this,windowNode,xOffset+buttonWidth*counter++, rowHeightRatio/4.2f, buttonWidth, rowHeightRatio/rowHeightDiv, 800f, "   Behvr.", "topbuttons/behavior.png" );
	    	actButton = new ImageButton("6",this,windowNode,xOffset+buttonWidth*counter++, rowHeightRatio/4.2f, buttonWidth, rowHeightRatio/rowHeightDiv, 800f, "  Action", "topbuttons/act.png" );
	    	searchButton = new ImageButton("7",this,windowNode,xOffset+buttonWidth*counter++, rowHeightRatio/4.2f, buttonWidth, rowHeightRatio/rowHeightDiv, 800f, "  Search", "topbuttons/search.png" );
