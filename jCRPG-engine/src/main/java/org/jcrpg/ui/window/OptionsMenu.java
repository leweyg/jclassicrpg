...
public class OptionsMenu extends PagedInputWindow {
    ...
    private static final String CONFIGFILE_PRESET_PREFIX  = "../media/configs/config-";
    ...
    static final String BG_IMAGE = "/baseWindowFrame.dds";
    ...
    public OptionsMenu(UIBase base) {
        ...
        try {
            ...
            pageFirst.attachChildAt(hudQuad,0);
            ...
            Quad header = loadImageToQuad("/mainmenu/"+MainMenu.OPTIONS, sizeX, sizeY, posX, posY);
            header.setRenderState(base.hud.hudAS);
            pageFirst.attachChildAt(header,0);
            ...
            tunerViewDistance.globalTooltip = "Sets the distance of the detailed tile based landscape to be rendered around the player. Over that distance a simpler terrain is used. Lowering means less stress on the system.";
            ...
            tunerRenderDistance.globalTooltip = "Sets the size of area to be preloaded while walking around. Higher value needs more memory, but means less frequent loads.";
            ...
            tunerRenderGrassDistance.globalTooltip = "Tunes the distance to which the grass is rendered. Using a lower value needs less powerful system.";
            ...
            tunerTextureDetail.globalTooltip = "0 - low, 1 - middle, 2 - high. Higher quality needs more Video RAM and system memory along with a more robust videocard.";
            ...
            tunerEffectsVolume.globalTooltip = "Sets the sound effects' volume level.";
            ...
            tunerMusicVolume.globalTooltip = "Sets the music volume level.";
            ...
            selectAntiAliasLevel.globalTooltip = "Sets the FSAA level.";
            ...
            pageSecond.attachChildAt(hudQuad2,0);

            // header
            Quad header2 = loadImageToQuad("/mainmenu/"+MainMenu.OPTIONS, sizeX, sizeY, posX, posY);
            header2.setRenderState(base.hud.hudAS);
            pageSecond.attachChildAt(header2,0);
            ...
            toggleContinuousLoad.globalTooltip = "Toggles between parallel area loading. It's experimental, turn it off if it crashes.";
            ...
            toggleNormalMapShader.globalTooltip = "Toggles the use of Normal maps. Switch on if you want bump mapped surfaces where available.";
            ...
            toggleNormalMapDetailed.globalTooltip = "Toggles the use of a more detailed Normal map shader.";
            ...
            selectWaterDeatil.globalTooltip = "Select what water graphics you want: Off (None), On (Simple) or Detailed.";
            ...
            toggleBloom.globalTooltip = "Toggles Bloom effect on/off. If this one is set on, Depth of Field won't be rendered.";
            ...
            toggleDepthOfField.globalTooltip = "Toggles Depth of Field effect on/off. If Bloom is set on, Depth of Field won't be rendered.";
            ...
            tunerShadowDistance.globalTooltip = "Set this one to Zero if you want to switch shadows off.";
            secondLayout.addToColumn(1, tunerShadowDistance, 0.35f, 0.5f);
            addInput(1, tunerShadowDistance);
            secondLayout.addToColumn(2, new TextLabel("",this, pageSecond, 600f, "", false), 3); // placeholder for rowspan
            ...
            toggleSlowAnimation.globalTooltip = "Set this On if you have a weaker system (CPU). If checked, animations will be skipped to a one frame/sec speed.";
