...
public class NormalActWindow extends PagedInputWindow {
	...
	public NormalActWindow (UIBase base) {
		...
		try {
			Quad hudQuad = loadImageToQuad("/nonPatternFrame1_trans.png", 0.75f*core.getDisplay().getWidth(), 1.63f*(core.getDisplay().getHeight() / 2), 
	    	...
	    	page0.attachChildAt(shQuad1);
	    	page0.attachChildAt(shQuad2);*/
