...
public class HashUtil {
	...
	public static int mixPercentage2(int seed, int a, int b, int c)
	{
		return (mix(a+seed,b,c)%100);//+50;
	}
	static HashSet<Integer> i = new HashSet<Integer>();
	public static void main(String[] args)
	{
		...
		while (true)
		{
			int i2 = mixPercentage(0, (int)(Math.random()*1000), 0, 0);
			count++;
			if (count>10000000)
			{
				count = 0;
			...
			System.out.println(i2);//mixPercentage(0, (int)(Math.random()*1000), 0, 0));
			if (i2<0 || i2>100) break;
			//if (count==100) break;*/
