...
export function validateContent(c) {
 ...
 for(const d of c.dialogues){if(!d.nodes[d.start])throw Error('Missing dialogue start');for(const n of Object.values(d.nodes))for(const choice of n.choices??[])if(choice.next&&!d.nodes[choice.next])throw Error('Dangling dialogue node');}
